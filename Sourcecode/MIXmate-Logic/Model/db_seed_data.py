# Start-Zutaten fuer eine frisch angelegte Datenbank.
# ingredient_id wird bewusst fest gesetzt, weil Rezepte und Pumpen darauf verweisen.
SEED_INGREDIENTS = [
...
# Start-Cocktails fuer Demo, Test und Erstbetrieb.
# cocktail_id bleibt stabil fuer Rezept- und Level-Zuordnungen.
SEED_COCKTAILS = [
...
# Verbindungstabelle zwischen Cocktail und Zutat.
# amount_ml ist die Zielmenge, order_index legt die Pump-Reihenfolge fest.
...
# Startbelegung der Pumpen.
# flow_rate_ml_s ist der Kalibrierwert, position_steps wird fachlich als mm genutzt.
SEED_PUMPS = [
...
# Start-Ebenen fuer das Regal.
# Weitere Ebenen werden spaeter ueber den Adminbereich angelegt.
SEED_LEVELS = [
    {"levelnumber": 1},
    {"levelnumber": 2},
]
...
# Keys sind bewusst sprechend, damit neue Parameter ohne Schemaaenderung moeglich sind.
SEED_MACHINE_PARAMETERS = [
    ...
    {"param_key": "load_unload_height_mm", "param_value": 0.0},
