...
class AdminLoginDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.username_edit.returnPressed.connect(btn_ok.click)
        self.password_edit.returnPressed.connect(btn_ok.click)
